...
R=Path(__file__).resolve().parents[1];pid=2734919;py='/home/aaltamimi2/.venvs/cosmo-logp/bin/python'
...
try:
 result=subprocess.run([py,'scripts/process_batch2_20260915.py'],cwd=R)
finally:
 ...
 (R/'state/batch2-worker-handoff.json').write_text(json.dumps(receipt,indent=2)+'\n');print(json.dumps(receipt),flush=True)
