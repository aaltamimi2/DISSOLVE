...
import numpy as np
R=Path('/mnt/r/plastchem-euler');D=R/'octanol-followup-2026-09-17';E=R/'combined-validation-references-2026-09-17-pubchem'
...
for p in [*R.glob('post*-octanol-2026-09-15/numerical-audit.json'),R/'octanol-catchup-2026-09-17/numerical-audit.json',D/'numerical-audit.json']:
...
O=R/'validation-expanded-2026-09-17';O.mkdir(exist_ok=True)
