...
for p in [*R.glob('post*-octanol-2026-09-15/numerical-audit.json'),R/'octanol-catchup-2026-09-17/numerical-audit.json',D/'numerical-audit.json',R/'octanol-post3883-2026-09-17/numerical-audit.json']:
...
O=R/'validation-comptox-later-2026-09-17';O.mkdir(exist_ok=False)
