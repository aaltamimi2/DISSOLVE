...
import numpy as np
R=Path('/mnt/r/plastchem-euler');D=R/'octanol-followup-2026-09-17';E=R/'combined-validation-references-2026-09-17-post4579'
...
O=R/'validation-pubchem-post4579-2026-09-17';O.mkdir(exist_ok=False)
