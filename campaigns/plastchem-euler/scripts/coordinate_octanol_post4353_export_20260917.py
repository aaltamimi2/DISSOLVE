...
ROOT=Path(__file__).resolve().parents[1];pid=983898;supervisor=1067824;P=Path(f'/proc/{pid}');receipt=ROOT/'state/octanol-post4353-export-boundary-20260917.json'
