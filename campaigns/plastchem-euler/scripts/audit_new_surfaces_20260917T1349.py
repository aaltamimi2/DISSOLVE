...
ROOT=Path(__file__).resolve().parents[1];R=Path('/mnt/r/plastchem-euler');D=R/'audits/surface-refresh-20260917T1349';D.mkdir(exist_ok=False)
prior={}
