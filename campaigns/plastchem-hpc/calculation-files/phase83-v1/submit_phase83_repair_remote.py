...
if found:
 ...
 script=D/'repair.sbatch';script.write_text((D/'phase83.sbatch').read_text().replace('phase83_worker.py "$SLURM_ARRAY_TASK_ID" "$1"','repair_phase83_staging.py "$SLURM_ARRAY_TASK_ID"'))
