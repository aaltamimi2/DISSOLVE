...
ROOT=Path.home()/'plastchem-euler/phase9-solvent-library-v1'
GROUP=sys.argv[1]
...
try:
 ...
 if 'avx2' not in result['cpu_flags'] or 'EPYC 7763' not in result['cpu_model']:fail('cpu_preflight','Missing AVX2 or wrong CPU family')
