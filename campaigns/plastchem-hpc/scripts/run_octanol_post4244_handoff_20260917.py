...
R=Path(__file__).resolve().parents[1];pid=894872;py='/home/aaltamimi2/.venvs/cosmo-logp/bin/python'
...
try:
 result=subprocess.run([py,'scripts/process_octanol_catchup_20260917.py'],cwd=R,env={**os.environ,'PLASTCHEM_OCTANOL_FILL_ROOT':'/mnt/r/plastchem-euler/octanol-post4244-2026-09-17'})
finally:
 ...
 (R/'state/octanol-post4244-worker-handoff-20260917.json').write_text(json.dumps(receipt,indent=2)+'\n');print(json.dumps(receipt),flush=True)
