...
import openpyxl
D=Path('/mnt/r/plastchem-euler/comptox-catchup-2026-09-17');S=D/'sources';cohort={r['inchikey']:r for r in json.loads((D/'cohort.json').read_text())['records']};fields=next(csv.reader((Path('/mnt/r/plastchem-euler/measured-expansion-2026-09-15/opera-experimental-reference-candidates.csv')).open()));out=[];excluded=[];counts={}
