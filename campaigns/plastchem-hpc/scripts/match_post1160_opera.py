...
D=Path('/mnt/r/plastchem-euler/post1160-octanol-2026-09-15');S=Path('/mnt/r/plastchem-euler/measured-expansion-2026-09-15/sources');cohort=json.loads((D/'cohort.json').read_text());receipt=json.loads((S/'OPERA_Data.retrieval.json').read_text());p=S/'LogP_QR.sdf';raw=p.read_bytes();digest=hashlib.sha256(raw).hexdigest();assert digest=='de50a1eb020ae42f7f89f8cb7dd73987048e80f30ef32eeaf376451cb832e489';rows=[]
