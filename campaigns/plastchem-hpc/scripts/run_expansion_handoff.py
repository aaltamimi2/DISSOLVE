...
R=Path(__file__).resolve().parents[1];pid=3678400;py='/home/aaltamimi2/.venvs/cosmo-logp/bin/python'
...
try:
 result=subprocess.run([py,'scripts/process_expansion_octanol.py'],cwd=R)
finally:
 ...
 (R/'state/expansion-worker-handoff.json').write_text(json.dumps(receipt,indent=2)+'\n');print(json.dumps(receipt),flush=True)
