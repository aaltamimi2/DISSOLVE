...
import openpyxl
ROOT=Path(__file__).resolve().parents[1];D=Path('/mnt/r/plastchem-euler/comptox-later-2026-09-17');S=D/'sources'
def run(name):subprocess.run(['python',str(ROOT/'scripts'/name)],check=True)
run('fetch_comptox_later_20260917.py')
