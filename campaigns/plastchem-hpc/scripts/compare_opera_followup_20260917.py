...
import numpy as np
R=Path('/mnt/r/plastchem-euler');D=R/'octanol-followup-2026-09-17';E=R/'combined-validation-references-2026-09-17-opera-followup'
...
O=R/'validation-opera-followup-2026-09-17';O.mkdir(exist_ok=False)
