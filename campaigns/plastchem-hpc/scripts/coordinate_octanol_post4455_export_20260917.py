...
ROOT=Path(__file__).resolve().parents[1];pid=1071660;supervisor=1141100;P=Path(f'/proc/{pid}');receipt=ROOT/'state/octanol-post4455-export-boundary-20260917.json'
