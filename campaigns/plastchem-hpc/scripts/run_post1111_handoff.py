...
R=Path(__file__).resolve().parents[1];pid=4041433;py='/home/aaltamimi2/.venvs/cosmo-logp/bin/python'
...
try:
 result=subprocess.run([py,'scripts/process_expansion_octanol.py'],cwd=R,env={**os.environ,'PLASTCHEM_OCTANOL_FILL_ROOT':'/mnt/r/plastchem-euler/post1111-octanol-2026-09-15'})
finally:
 ...
 (R/'state/post1111-worker-handoff.json').write_text(json.dumps(receipt,indent=2)+'\n');print(json.dumps(receipt),flush=True)
