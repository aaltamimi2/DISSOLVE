"""Seal newly completed 32-reference records not covered by the first audit."""
...
R=Path('/home/aaltamimi2/plastchem-euler');D=Path('/mnt/r/plastchem-euler/audits/resolved32-increment-20260917T2008');D.mkdir(parents=True,exist_ok=False)
...
prior=json.loads((Path('/mnt/r/plastchem-euler/audits/first32-panel-20260917T1833/sealed-thermodynamics/processing-ledger.json')).read_text())
selected={k:v for k,v in selected.items() if prior.get(k,{}).get('result_sha256')!=v['result_sha256']}
