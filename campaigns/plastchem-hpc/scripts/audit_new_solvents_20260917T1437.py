...
ROOT=Path(__file__).resolve().parents[1];R=Path('/mnt/r/plastchem-euler');D=R/'audits/surface-refresh-20260917T1437-solvents';D.mkdir(exist_ok=False)
prior={}
...
for p in sorted((ROOT/'state/campaign-v1/records').glob('*.json')):
 ...
 if p.stem not in {'HPXRVTGHNJAIIH-UHFFFAOYSA-N','VLKZOEOYAKHREP-UHFFFAOYSA-N','ZMANZCXQSJIPKH-UHFFFAOYSA-N'}:continue
