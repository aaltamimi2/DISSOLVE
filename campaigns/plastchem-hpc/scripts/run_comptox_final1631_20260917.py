...
import openpyxl
ROOT=Path(__file__).resolve().parents[1];D=Path('/mnt/r/plastchem-euler/comptox-final1631-2026-09-17');S=D/'sources'
def run(name):subprocess.run(['python',str(ROOT/'scripts'/name)],check=True)
run('fetch_comptox_final1631_20260917.py')
