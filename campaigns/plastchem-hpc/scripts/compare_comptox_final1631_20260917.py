...
import numpy as np
R=Path('/mnt/r/plastchem-euler');D=R/'octanol-followup-2026-09-17';E=R/'combined-validation-references-2026-09-17-comptox-final1631'
...
O=R/'validation-comptox-final1631-2026-09-17';O.mkdir(exist_ok=False)
