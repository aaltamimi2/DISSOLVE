...
R=Path(__file__).resolve().parents[1];pid=3751181;py='/home/aaltamimi2/.venvs/cosmo-logp/bin/python'
...
try:
 result=subprocess.run([py,'scripts/process_expansion_octanol.py'],cwd=R,env={**os.environ,'PLASTCHEM_OCTANOL_FILL_ROOT':'/mnt/r/plastchem-euler/post960-octanol-2026-09-15'})
finally:
 ...
 (R/'state/post960-worker-handoff.json').write_text(json.dumps(receipt,indent=2)+'\n');print(json.dumps(receipt),flush=True)
