...
R=Path('/mnt/r/plastchem-euler/octanol-catchup-2026-09-17/cumulative-validation')
raw=(R/'parity.csv').read_bytes();rows=list(csv.DictReader(raw.decode().splitlines()))
