...
SOURCE=Path('/mnt/r/plastchem-euler/octanol-post4060-2026-09-17/cumulative-validation')
R=Path('/mnt/r/plastchem-euler/validation-sensitivity-20260917-n447');R.mkdir(exist_ok=False)
