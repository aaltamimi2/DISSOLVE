...
R=Path('/home/aaltamimi2/plastchem-euler');D=Path('/mnt/r/plastchem-euler/polymer-v1/route-comparison-a7/nylon66');D.mkdir(parents=True,exist_ok=True)
...
models=[m for m in json.loads((R/'state/polymer-v1/body/manifest.json').read_text())['molecules'] if m['polymer']=='nylon66'];assert len(models)==28
